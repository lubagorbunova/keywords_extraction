...
def lab_2(text: str, top_n: int, max_length: int) -> tuple:
    ...
    return candidate_keyword_phrases, extracted_phrases, word_scores, top_n_phrases
...
def lab_2_2(candidate_keyword_phrases: Optional[KeyPhrases],
    ...
    print('candidate_keyword_phrases_with_adjoining = ', candidate_keyword_phrases_with_adjoining, '\n',
...
if __name__ == "__main__":
    ...
    for value in corpus.values():
        candidate_keyword_phrases, extracted_phrases, word_scores, top_n_phrases = lab_2(value, 3, 3)
        lab_2_2(candidate_keyword_phrases, extracted_phrases, word_scores)
